...
F 3 "~" H 6825 6000 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 8525 5950 0    50   Input ~ 0
col4
Text GLabel 8525 6050 0    50   Input ~ 0
col3
Text GLabel 8525 6150 0    50   Input ~ 0
col2
Text GLabel 8525 6550 0    50   Input ~ 0
col1
Text GLabel 8525 5450 0    50   Input ~ 0
col0
Text GLabel 9225 5050 1    50   Input ~ 0
row2
Text GLabel 9325 5050 1    50   Input ~ 0
row1
Text GLabel 9425 5050 1    50   Input ~ 0
row3
Text GLabel 9925 5450 2    50   Input ~ 0
row0
Text GLabel 9925 5550 2    50   Input ~ 0
col7
Text GLabel 9925 5650 2    50   Input ~ 0
col9
Text GLabel 9925 5750 2    50   Input ~ 0
col6
Text GLabel 9925 5850 2    50   Input ~ 0
col5
Text GLabel 9925 5950 2    50   Input ~ 0
col8
$Comp
L power:GND #PWR0108
U 1 1 60E37719
P 9925 6350
F 0 "#PWR0108" H 9925 6100 50  0001 C CNN
F 1 "GND" V 9930 6222 50  0000 R CNN
F 2 "" H 9925 6350 50  0001 C CNN
F 3 "" H 9925 6350 50  0001 C CNN
	1    9925 6350
	0    -1   -1   0   
$EndComp
NoConn ~ 9925 6450
